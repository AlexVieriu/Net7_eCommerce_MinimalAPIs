...
// Product
#region Product
app.MapGet("/product/{id:int}", async ([FromRoute] int id, IProductRepository productRepo) =>
{
...
app.MapGet("/product", async ([FromQuery] string filter, IProductRepository productRepo) =>
{
    try
    {
...
//Order
#region Order
app.MapPost("/order", async ([FromBody] Order order, IOrderRepository orderRepo) =>
{
    try
    {
...
app.MapGet("/order/lineItems/{orderId:int}", async ([FromRoute] int orderId, IOrderRepository orderRepo) =>
{
    try
    {
...
app.MapGet("/order/{orderId:int}", async ([FromRoute] int orderId, IOrderRepository orderRepo) =>
{
    try
    {
...
app.MapGet("/order/{uniqueId}", async ([FromRoute] string uniqueId, IOrderRepository orderRepo) =>
{
    try
    {
...
app.MapPut("/order/processed/{id:int}", async ([FromRoute] int id, [FromBody] Order order, IOrderRepository orderRepo) =>
{
    try
    {
        if (id < 1)
